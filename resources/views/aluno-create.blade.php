...
<body>
    ...
    <form method="POST" action="/create-user">
        ...
        <div class="form-group">
            ...
            <input type="text" id="escola_instituicao" name="escola_instituicao"
                value="{{ old('escola_instituicao') }}" placeholder="Nome da escola ou instituição" required>
        ...
        <div class="form-group">
            ...
            <select id="ano_escolaridade" name="ano_escolaridade" required>
                ...
                @for ($i = 1; $i <= 12; $i++)
                    <option value="{{ $i }}" {{ old('ano_escolaridade') == $i ? 'selected' : '' }}>
                        {{ $i }}º ano</option>
                @endfor
            </select>
